// building out our decentralized blockchain network
...
app.post("/transaction", function(req, res) {
    ...
    const blockIndex = testcoin.addTransactionToPendingTransactions(newTransaction);
...
app.post("/register-and-broadcast-node", function(req, res) {
    ...
    if(nodeNotAlreadyPresent) testcoin.networkNodes.push(newNodeUrl);
    ...
    .then(data => {
        const bulkRegisterOptions = {
            ...
            method: "POST",
            body: { allNetworkNodes: [ ...testcoin.networkNodes, testcoin.currentNodeUrl ] },
            json: true
        };
...
app.get('/transaction/:transactionId', function(req, res) {
    ...
    const transactionData = testcoin.getTransaction(transactionId);
    res.json({
